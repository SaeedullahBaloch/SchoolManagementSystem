...
<div id="wrapper" class="wrapper bg-ash">
       ...
       <div class="breadcrumbs-area">
                 ...
                 <div class="card-body">
                  ...
                  <div class="table-responsive">
                   <br/>
  <label for="ExamID">ExamID:</label><br>
  ...
  <label for="TotalMarks">TotalMarks:</label><br>
  <input type="text" id="TotalMarks" name="TotalMarks"><br>
  <label for="ObtainedMarks">ObtainedMarks:</label><br>
   <input type="text" id="ObtainedMarks" name="ObtainedMarks"><br>
