...
Mark_listing themarks  = new Mark_listingProxy().getMark_listing();
 Marks_list el[] = themarks.mark_listing();
%>
...
<% 
	...
	out.print("<td>" + 	el[i].getExamID()+"</td>");
	out.print("<td>" + 	el[i].getStudentID()+ "</td>");
	out.print("<td>" + 	el[i].getTeacherID()+ "</td>");
	out.print("<td>" + 	el[i].getObtainedMarks()+ "</td>");
	out.print("<td>" + 	el[i].getTotalMarks()+"</td>");
	out.print("<td>" + 	el[i].getResult()+ "</td>");
