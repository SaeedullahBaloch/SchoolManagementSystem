<%@page import="Exam.Listing_ExamProxy"%>
<%@page import="Exam.Listing_Exam"%>
<%@page import="Exam.Exam_list"%>
...
Listing_Exam exam = new Listing_ExamProxy().getListing_Exam();
Exam_list exams[]= exam.listing_Exams();
%>
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                   ...
                                   <li class="nav-item">
                                    <a href="CreatExam.jsp" class="nav-link"><i class="fas fa-angle-right"></i>Add Exam</a>
                                </li>
                                  <li class="nav-item">
...
for(int i=0; i< exams.length; i++)
{
	...
	<% 
	out.print("<td>" + exams[i].getExamID() + "</td>");
	out.print("<td>" + exams[i].getName() + "</td>");
	out.print("<td>" + exams[i].getStartDate() + "</td>");
	out.print("<td>" + exams[i].getEndDate() + "</td>");
	out.print("<td>" + exams[i].getStatus() + "</td>");
