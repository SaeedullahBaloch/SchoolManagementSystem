        ...
        <div class="navbar navbar-expand-md header-menu-one bg-light">
            <div class="nav-bar-header-one">
                <div class="header-logo">
                    <a href="index.html">
                        <img src="Assets/img/Mylogo2.png" alt="logo">
                    </a>
                </div>
                 ...
                 <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table display data-table text-nowrap">
                                ...
                                ListingVoucher lv = new ListingVoucherProxy().getListingVoucher();
                                VoucherList [] voucher = lv.vouchers();
                               ...
                               for(int i=0; i<voucher.length; i++)
                               {
                            	   ...
                            	   %>
                            	   <td>
                            	    <a href="EditVoucher.jsp?id=<%=voucher[i].getId()%>"> Edit </a>
                            	   </td>
                            	   <% 
                            	   
                            	   out.print("<td>" + voucher[i].getId() + "</td>");
                            	   out.print("<td>" + voucher[i].getStudentName()+ "</td>");
                            	   out.print("<td>" + voucher[i].getFeeMonth()+ "</td>");
                            	   out.print("<td>" + voucher[i].getDate()+ "</td>");
                            	   out.print("<td>" + voucher[i].getAmount() + "</td>");
