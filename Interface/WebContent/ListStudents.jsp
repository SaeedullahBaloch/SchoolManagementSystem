...
ListingStudents lsStudents  = new ListingStudentsProxy().getListingStudents();
StudentList ls[] = lsStudents.listAllStudents();
%>
...
%>
<td>
<a href="ShowSearchDetail.jsp?AdmissionID=<%= ls[i].getAdmissionNumber()%>"> Select </a>
</td>
<% 
	out.print("<td>" + 	ls[i].getAdmissionNumber()+ "</td>");
	out.print("<td>" + 	ls[i].getName()+ "</td>");
	out.print("<td>" + 	ls[i].getFather()+ "</td>");
	out.print("<td>" + 	ls[i].getDOB()+ "</td>");
	out.print("<td>" + 	ls[i].getPhone()+ "</td>");
	out.print("<td>" + 	ls[i].getAddress()+ "</td>");
