<%@page import="feeCollection.CollectFeeProxy"%>
<%@page import="feeCollection.CollectFee"%>
...
<body>
<%
CollectFee fee = new CollectFeeProxy().getCollectFee();

int i=fee.collectStudentFee(Integer.parseInt(request.getParameter("FeeID")), Integer.parseInt(request.getParameter("StudentID")), request.getParameter("Month"),request.getParameter("Date"), Integer.parseInt(request.getParameter("Amount")));
