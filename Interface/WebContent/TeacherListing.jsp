...
<%@page import="Teaching.ListTeachers"%>
...
<body>
<%
TeacherListing teacherlist=new TeacherListingProxy().getTeacherListing();
ListTeachers teacherlists[]=teacherlist.listAllTeachers();
%>
...
<body>
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    <a href="SearchStudent.jsp" class="nav-link"><i
       ...
       <div class="breadcrumbs-area">
                 ...
                 <div class="card-body">
                  ...
                  <div class="heading-layout1">
                        ...
                        <form action="ShowSearchDetail.jsp" class="mg-b-20">
                            <div class="row gutters-8">
                                <div class="col-3-xxxl col-xl-3 col-lg-3 col-12 form-group">
                                    <input name="AdmissionID" type="text" placeholder="Search by Roll ..." class="form-control">
                                </div>
 ...
 for(int i=0; i<teacherlists.length; i++){
	 ...
	 out.print("<tr>");
	 %>
	<td>  <a href="update.jsp?id=<%=teacherlists[i].getTeacherID()%>"> Edit</a> </td>
	 <% 
	 out.print("<td>"+teacherlists[i].getTeacherID()+"</td>");
	out.print("<td>"+teacherlists[i].getRegistrationNumber()+"</td>");
	out.print("<td>"+teacherlists[i].getName()+"</td>");
	out.print("<td>"+teacherlists[i].getFather()+"</td>");
	out.print("<td>"+teacherlists[i].getDateOfBirth()+"</td>");
	out.print("<td>"+teacherlists[i].getPhone()+"</td>");
	out.print("<td>"+teacherlists[i].getCNIC()+"</td>");
	out.print("<td>"+teacherlists[i].getQualification()+"</td>");
	out.print("<td>"+teacherlists[i].getAddress()+"</td>");
	out.print("<td>"+teacherlists[i].getRegistrationDate()+"</td>");
	out.print("<td>"+teacherlists[i].getStatus()+"</td>");
